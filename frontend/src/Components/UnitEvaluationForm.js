  ...
  return (
    ...
    <div className="page-content">
        ...
        <div className="page-title-small color-white bottom-30">
            <h1 onclick="window.location='dashboard.html'"><i className="fa fa-arrow-left back-button"></i>Unit Evauation Form</h1>
        ...
        <div className="content-boxed bg-theme shadow-large bottom-30">
            <h5 className="center-text font-800 font-30 uppercase">Team Name</h5>
...
export default UnitEvaluationForm;
