  ...
  return (
    ...
    <div className="page-content">
        ...
        <div className="content-boxed bg-theme shadow-large bottom-30">
            <h5 className="center-text font-800 font-30 uppercase">School Registration</h5>
            <form action="functionality/prescription_act.php" method="POST">
                                      ...
                                      <div className="table-responsive">
                                        <table className="table " id="dynamic_field">
                                          <tr>
                                            <td><input type="text" name="symptoms[]" placeholder="School Name" className="form-control name_list transparent-input" /></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <b>School Address</b>
                                      <div className="table-responsive">
                                        <table className="table " id="dynamic_field2">
                                          <tr>
                                            <td><input type="text" name="findings[]" placeholder="School Location" className="form-control name_list transparent-input" /></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <b>Email Adress</b>
                                      ...
                                      <div className="table-responsive">
                                        <table className="table " id="dynamic_field5">
                                          <tr>
                                            <td><input type="text" name="labtests[]" placeholder="Name of the Principal" className="form-control name_list transparent-input" /></td>
                                          </tr>
                                        </table>
                                      </div>
                                      </form>
