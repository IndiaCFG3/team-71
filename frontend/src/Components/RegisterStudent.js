  ...
  return (
    ...
    <div className="page-content">
        ...
        <div className="content-boxed bg-theme shadow-large bottom-30">
            <h5 className="center-text font-800 font-30 uppercase">Student Registration</h5>
            <form action="functionality/prescription_act.php" method="POST">
                                      <b>Name</b>
                                      <div className="table-responsive">
                                        <table className="table " id="dynamic_field">
                                          <tr>
                                            <td><input type="text" name="symptoms[]" placeholder="Student Name" className="form-control name_list transparent-input" /></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <b>Roll Number</b>
                                      <div className="table-responsive">
                                        <table className="table " id="dynamic_field2">
                                          <tr>
                                            <td><input type="text" name="findings[]" placeholder="Roll Number" className="form-control name_list transparent-input" /></td>
                                          </tr>
                                        </table>
                                      </div>
                                      <b>Email Adress</b>
